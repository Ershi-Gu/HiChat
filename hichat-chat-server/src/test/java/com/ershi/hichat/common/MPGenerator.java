...
public class MPGenerator {
    public static void main(String[] args) {
        ...
        //todo 要改输出路径
        globalConfig.setOutputDir(System.getProperty("user.dir") + "/hichat-chat-server/src/main/java");
        //设置作者名字
        globalConfig.setAuthor("<a href=\"https://github.com/Ershi-Gu\">Ershi</a>");
        ...
        packageConfig.setParent("com.ershi.hichat.common.user");//自定义包的路径
...
//        strategyConfig.setTableFillList(list);
    ...
    public static void assembleDev(DataSourceConfig dataSourceConfig) {
        ...
        dataSourceConfig.setPassword("200303078");
        dataSourceConfig.setUrl("jdbc:mysql://127.0.0.1:3306/hichat?useUnicode=true&characterEncoding=utf-8&useSSL=true&serverTimezone=UTC");
    }
}